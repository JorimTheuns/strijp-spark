export default function Button({
  ...
  return (
    <button
      ...
      type="button"
      className={`px-4 py-2 border-blackish border-4 text-blackish hover:bg-day-teal hover:scale-105 focus:ring-2 ring-day-teal active:scale-95 transition-all duration-150 ease-in-out" ${classes}`}
    >
      {children}
    </button>
  )
